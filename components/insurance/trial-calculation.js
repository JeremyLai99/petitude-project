    ...
    <>
      ...
      <div className={`container-fluid ${styles.allFont}`}>
        ...
        >
          ...
          <h5
            className={`d-none d-md-flex justify-content-center align-items-center ${styles['text-color']} mt-2 `}
          >
            最低每天只要$5起
          </h5>
          {/* 表格 電腦版*/}
          <div className="col-8 mt-4 d-none d-md-block">
          ...
          <div className="d-md-none">
            <div className="mobile-header">
              <h2 className={styles['text-color']}>方案介紹</h2>
              <h5 className={styles['text-color']}>最低每天只要$5起</h5>
            </div>
            ...
            <table className="mobile-table">
              <tbody>
                  ...
                  <th>
                    ...
                    >
                      ...
                      <div className="mobile-price">
                        $<span className="price-amount">{basicPlan}</span>
                        <span>起/年</span>
                      </div>
                      <button
                        className={`${styles['own-btn4']} mobile-button`}
                        onClick={() => handleButtonClick('基礎方案')}
                      >
                        立即投保
                      </button>
                ...
                <tr>
                  <td>
                    <h5>寵物醫療費用保險</h5>
                    <p>每次門診費用: 一年最高1次，每次最高$1,000</p>
                    <p>每次住院費用: 一年最高1次，每次最高$5,000</p>
                    <p>每次手術費用: 一年最高1次，每次最高$20,000</p>
                    <p>保險期間累積最高賠償限額: $25,000</p>
                  </td>
                </tr>
                <tr>
                  <td>
                    <h5>寵物侵權責任保險</h5>
                    <p>每一個人體傷害責任: $100,000</p>
                    <p>每一意外傷害責任: $200,000</p>
                    <p>每一意外事故財物損失責任: $50,000</p>
                    <p>保險期間最高賠償金額: $500,000</p>
                  </td>
                </tr>
                ...
                <tr>
                  <th>
                    ...
                    >
                      ...
                      <p>(自負額: 損失之30%)</p>
                      <div className="mobile-price">
                        $<span className="price-amount">{advancedPlan}</span>
                        <span>起/年</span>
                      </div>
                      <button
                        className={`${styles['own-btn4']} mobile-button`}
                ...
                <tr>
                  <td>
                    <h5>寵物醫療費用保險</h5>
                    <p>每次門診費用: 一年最高3次，每次最高$1,000</p>
                    <p>每次住院費用: 一年最高1次，每次最高$5,000</p>
                    <p>每次手術費用: 一年最高1次，每次最高$20,000</p>
                    <p>保險期間累積最高賠償限額: $28,000</p>
                  </td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  <th>
                    ...
                    >
                      ...
                      <p>(自負額: 損失之30%)</p>
                      <div className="mobile-price">
                        $<span className="price-amount">{fullPlan}</span>
                        <span>起/年</span>
                      </div>
                      <button
                        className={`${styles['own-btn4']} mobile-button`}
                ...
                <tr>
                  <td>
                    <h5>寵物醫療費用保險</h5>
                    <p>每次門診費用: 一年最高5次，每次最高$1,200</p>
                    <p>每次住院費用: 一年最高2次，每次最高$5,000</p>
                    <p>每次手術費用: 一年最高2次，每次最高$20,000</p>
                    <p>保險期間累積最高賠償限額: $56,000</p>
                  </td>
                </tr>
                <tr>
                  <td>
